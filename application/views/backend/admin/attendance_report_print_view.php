...
<div id="print">
	...
	<center>
		<img src="<?php echo base_url().'assets/themes/'.$theme.'/img/logo/icon.png';?>" style="max-height : 90px;"><br>
    ...
    for ($i = 1; $i <= $days; $i++) {
        ?>
                ...
                <tbody>
                        ...
                        <tr>
                            <td style="text-align: center;">
                            <?php echo $studentdata->first_name.' '.$studentdata->middle_name.' '.$studentdata->last_name.' ('.$studentdata->student_code.')'; ?>
                            </td>
                            <?php
                            $status = 0;
                            for ($i = 1; $i <= $days; $i++) {
