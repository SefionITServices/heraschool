<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <!--ADMISION-->
<li class="<?php if ($page_name == 'manage_science_admission' ||
                                $page_name == 'manage_commerce_admission' || $page_name == 'manage_arts_admission')
                                                echo 'opened active has-sub';
        ?> ">
            <a href="#">
                <i class="fa fa-group"></i>
            ...
            <ul>
                <!-- Admission Science -->
                <li class="<?php if ($page_name == 'manage_science_admission') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/manage_science_admission'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('science_admission'); ?></span>
                    </a>
                </li>

                <!-- Admission commerce -->
                <li class="<?php if ($page_name == 'manage_commerce_admission') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/manage_commerce_admission'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('commerce_admission'); ?></span>
                    </a>
                </li>
                ...
                <!-- Addmission arts -->
                <li class="<?php if ($page_name == 'manage_arts_admission') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/manage_arts_admission'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('arts_admission'); ?></span>
                    </a>
                </li>
...
<!--ADMISION END-->
        ...
        <!-- Hall of Fame -->
        <li class="<?php if ($page_name == 'add_hall_of_fame' || $page_name == 'edit_hall_of_fame' || $page_name == 'manage_hall_of_fame')
                                                echo 'opened active has-sub';
        ?> ">
            <a href="#">
            ...
            <ul>
                <!-- Add -->
                <li class="<?php if ($page_name == 'add_hall_of_fame') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/add_hall_of_fame'); ?>">
                        <span><i class="entypo-dot"></i> Add Hall of Fame</span>
                    </a>
                </li>
                <!-- Manage -->
                <li class="<?php if ($page_name == 'manage_hall_of_fame') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/manage_hall_of_fame'); ?>">
                        <span><i class="entypo-dot"></i> Manage Hall of Fame</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="<?php if ($page_name == 'noticeboard' || $page_name == 'noticeboard_edit') echo 'active'; ?> ">
           ...
           <li class="<?php
        if ($page_name == 'add_post' || $page_name == 'edit_post' ||
                $page_name == 'manage_post')
                            echo 'opened active';
        ?> ">
            <a href="#">
                <i class="entypo-suitcase"></i>
            ...
            <ul>
                <li class="<?php if ($page_name == 'add_post') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/add_post'); ?>">
                        <span><i class="entypo-dot"></i> Add Post</span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'manage_post') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/manage_post'); ?>">
                        <span><i class="entypo-dot"></i> Manage Post</span>
                    </a>
                </li>
