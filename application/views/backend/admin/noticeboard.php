                ...
                <div class="box-content">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label"><?php echo get_phrase('notice'); ?></label>
                  		<div class="col-sm-5">
                  		  <textarea id="texteditor" class="form-control" rows="5" name="notice"></textarea>
                  		</div>
                  	</div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <input type="file" name="file1" class="form-control file2 inline btn btn-primary" data-label="<i class='glyphicon glyphicon-file'></i> Browse" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control selectboxit" name="check_sms">
                                <option value="1"><?php echo get_phrase('yes'); ?></option>
                                <option value="2" selected=""><?php echo get_phrase('no'); ?></option>
                            </select>
                            <br>
                            <span class="badge badge-primary">
                                <?php
                                if ($active_sms_service == 'sefion')
                                    echo 'Sefion SMS ' . get_phrase('activated');
