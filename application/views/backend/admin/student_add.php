<div class="row">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/student/create/') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('admission_year');?></label>
		                    <div class="col-sm-5">

			                    <input type="number" id="admission_year" class="form-control" name="admission_year" value="<?php echo date('Y'); ?>">
			                </div>
					</div>
	...
	<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="address_line1" value="" placeholder="Address Line 1" required=""><br>
							<input type="text" class="form-control" name="address_line2" placeholder="Address Line 2" value="" ><br>
							<input type="text" class="form-control" placeholder="Address Line 3" name="address_line3" value="" >
						</div>

					</div>
				<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('city');?></label>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('region');?></label>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('country');?></label>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('phone').'/'.get_phrase('moblie');?></label>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="email" class="form-control" name="email" data-message-required="<?php echo get_phrase('value_required');?>" value="">
						</div>
					</div>
