...
<div class="row">
	<div class="col-md-12">
	 ...
	 <?php 
$get_student = $this->db->get_where('student' , array('student_id' => $row['student_id']))->row();
                        ?>
					<div class="form-group">
					...
					<input type="text" class="form-control" name="first_name" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" 
								value="<?php echo $get_student->first_name; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Middle name</label>
						<div class="col-sm-5">
					<input type="text" class="form-control" name="middle_name" value="<?php echo $get_student->middle_name; ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
					<input type="text" class="form-control" name="last_name" value="<?php echo $get_student->last_name; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="Address line 1" class="form-control" name="address_line1" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->address_line1; ?>" >
								<input type="text" placeholder="Address line 2"  class="form-control" name="address_line2" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->address_line2; ?>" >
								<input type="text" placeholder="Address line 3" class="form-control" name="address_line3" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->address_line3; ?>" >
