                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                $get_student = $this->db->get_where('student' , array('student_id' => $row['student_id']))->row();
                                    echo $get_student->first_name.' '.$get_student->middle_name.' '.$get_student->last_name;
                                ?>
                            </td>
                            <td>
                                <?php
                                    echo $this->db->get_where('student' , array(
                                        'student_id' => $row['student_id']
                                    ))->row()->address_line1.' '.$this->db->get_where('student' , array(
                                        'student_id' => $row['student_id']
                                    ))->row()->address_line2.' '.$this->db->get_where('student' , array(
                                        'student_id' => $row['student_id']
                                    ))->row()->address_line3;
                                ?>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="<?php echo site_url('admin/student_edit/'.$row['student_id']);?>">
                ...
                <table class="table table-bordered datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                $get_student_a  = $this->db->get_where('student' , array('student_id' => $row['student_id']))->row();
                               echo  $get_student_a->first_name.' '.$get_student_a->middle_name.' '.$get_student_a->last_name;
                                ?>
                            </td>
                            <td>
                                <?php
                    $get_address = $this->db->get_where('student' , array('student_id' => $row['student_id']))->row();
                 echo  $get_address->address_line1.' '.$get_address->address_line2.' '.$get_address->address_line3;
