...
<body style="font-family: calibri; font-size: 16px;" onload="printdiv()">
        ...
        <div class="row mb10" style="margin-bottom:20px;">
            ...
            <div class="col-md-6 col-sm-6 ptext" style="text-align:right;">
                <img src="<?php echo base_url(); ?>assets/themes/dhs/assets/ui/affix_pp_photo.jpg" style="height: 150px; width: 150px; ">
            </div>
        </div>
    ...
    <div align="center"><a href="<?php echo site_url().'/home/print_form/'.$data[0]['form_number']; ?>"  class="btn btn-info">Print</a></div>
